...
class XRexec implements ActionListener{
  private final TextField name=new TextField(8);
  private final TextField host=new TextField(20);
  private final TextField passwd=new TextField(8);
  private final TextField command=new TextField(20);
  private final Button rexec=new Button("REXEC");
  ...
  public void actionPerformed(java.awt.event.ActionEvent e) {
    char [] pass=null;
    try{pass=passwd.getText().toCharArray();}catch(Exception ee){}
